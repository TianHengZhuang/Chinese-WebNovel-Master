...
| [blurb_synopsis_generator.md](tools/blurb_synopsis_generator.md) | Listing copy: one-liner, short/long synopsis, tags, title fit |
...
* v2.4.4 — README tools table completes the 12-tool set
